...
class WriteFiles:
    ...
    def write_log(
        ...
        if (
            ...
            or removes.aftermarket_removes
            ...
            if removes.aftermarket_removes:
                log_file_contents.append('* AFTERMARKET REMOVES\n')
            ...
            user_removes('aftermarket', removes.aftermarket_removes)
