...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContentsSystemOverrides.setGeometry(QRect(0, 0, 590, 405))
        ...
        self.scrollAreaWidgetContentsSystemPostFilters.setGeometry(QRect(0, 0, 590, 405))
...
#endif // QT_CONFIG(tooltip)
        self.checkBoxGlobalOptionsOriginalHeader.setText(QCoreApplication.translate("MainWindow", u"Use the original input DAT header in the output DAT", None))
#if QT_CONFIG(tooltip)
...
"and No-Intro DATs already in CLRMAMEPro", None))
#endif // QT_CONFIG(tooltip)
        self.checkBoxSystemOptionsOriginalHeader.setText(QCoreApplication.translate("MainWindow", u"Use the original input DAT header in the output DAT", None))
#if QT_CONFIG(tooltip)
