...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutRight_2.setMinimumSize(QSize(650, 0))
        ...
        self.scrollAreaWidgetContentsGlobalOptions.setGeometry(QRect(0, 0, 573, 760))
        ...
        self.scrollAreaGlobalUserFilters.setFocusPolicy(Qt.NoFocus)
        ...
        self.scrollAreaWidgetContentsGlobalUserFilters.setGeometry(QRect(0, 0, 590, 393))
        ...
        QWidget.setTabOrder(self.checkBoxGlobalExcludeEducational, self.checkBoxGlobalExcludeManuals)
        QWidget.setTabOrder(self.checkBoxGlobalExcludeManuals, self.checkBoxGlobalExcludeMIA)
        QWidget.setTabOrder(self.checkBoxGlobalExcludeMIA, self.checkBoxGlobalExcludeMultimedia)
        QWidget.setTabOrder(self.checkBoxGlobalExcludeMultimedia, self.checkBoxGlobalExcludePirate)
        QWidget.setTabOrder(self.checkBoxGlobalExcludePirate, self.checkBoxGlobalExcludePreproduction)
        QWidget.setTabOrder(self.checkBoxGlobalExcludePreproduction, self.checkBoxGlobalExcludePromotional)
        QWidget.setTabOrder(self.checkBoxGlobalExcludePromotional, self.checkBoxGlobalExcludeUnlicensed)
        QWidget.setTabOrder(self.checkBoxGlobalExcludeUnlicensed, self.checkBoxGlobalExcludeVideo)
        QWidget.setTabOrder(self.checkBoxGlobalExcludeVideo, self.buttonGlobalSelectAllExclude)
        ...
        QWidget.setTabOrder(self.checkBoxGlobalOptionsDemoteUnlicensed, self.checkBoxGlobalOptionsDisableFilters)
        QWidget.setTabOrder(self.checkBoxGlobalOptionsDisableFilters, self.checkBoxGlobalOptionsSplitRegions)
        ...
        QWidget.setTabOrder(self.checkBoxSystemExcludeEducational, self.checkBoxSystemExcludeManuals)
        QWidget.setTabOrder(self.checkBoxSystemExcludeManuals, self.checkBoxSystemExcludeMIA)
        QWidget.setTabOrder(self.checkBoxSystemExcludeMIA, self.checkBoxSystemExcludeMultimedia)
        QWidget.setTabOrder(self.checkBoxSystemExcludeMultimedia, self.checkBoxSystemExcludePirate)
        QWidget.setTabOrder(self.checkBoxSystemExcludePirate, self.checkBoxSystemExcludePreproduction)
        QWidget.setTabOrder(self.checkBoxSystemExcludePreproduction, self.checkBoxSystemExcludePromotional)
        QWidget.setTabOrder(self.checkBoxSystemExcludePromotional, self.checkBoxSystemExcludeUnlicensed)
        QWidget.setTabOrder(self.checkBoxSystemExcludeUnlicensed, self.checkBoxSystemExcludeVideo)
        QWidget.setTabOrder(self.checkBoxSystemExcludeVideo, self.buttonSystemSelectAllExclude)
        ...
        QWidget.setTabOrder(self.checkBoxSystemOptionsDemoteUnlicensed, self.checkBoxSystemOptionsDisableFilters)
        QWidget.setTabOrder(self.checkBoxSystemOptionsDisableFilters, self.checkBoxSystemOptionsSplitRegions)
