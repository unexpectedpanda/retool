...
def xbox_rename_list():
    return [
        ...
        # Alfa Romeo Racing Italiano isn't in Redump yet
        # 'SCAR - Squadra Corse Alfa Romeo',

        # Amped - Freestyle Snowboarding
        'Tenku - Freestyle Snowboarding', # (天空)
        ...
        'Crash Bandicoot 4 - Sakuretsu! Majin Power', # (クラッシュ・バンディクー４　さくれつ！魔神パワー)

        # Crimson Sea
        'Kurenai no Umi - Crimson Sea', # (紅の海)

        # Dai Senryaku VII - Modern Military Tactics
        'Daisenryaku VII', # (大戦略 VII)
        ...
        'Digimon Battle Chronicle', # (デジモンバトルクロニクル)

        # Digimon World 4
        'Digimon World X', # (デジモンワールドＸ)
        ...
        # Dynasty Warriors 3
        'Shin Sangoku Musou 2', # (真・三國無双２)

        # Dynasty Warriors 4
        'Shin Sangoku Musou 3', # (真・三國無双３)

        # Dynasty Warriors 5
        'Shin Sangoku Musou 4', # (真・三國無双４)
        ...
        # Group S Challenge
        'Circus Drive', # (サーカスドライブ)

        # Guilty Gear X2 Reload - The Midnight Carnival
        'Guilty Gear XX Reload - The Midnight Carnival', # (ギルティギア　イグゼクス シャープリロード)
        ...
        'Hello Kitty - Mission Rescue', # (Hello Kitty 友情總動員)

        # Hitman 2 - Silent Assassin
        'Hitman - Silent Assassin', # (ヒットマン：サイレントアサシン)

        # Jade Empire
        'Jade Empire - Hisui no Teikoku', # (ジェイド　エンパイア　～翡翠の帝国～)

        # Kabuki Warriors
        'Zan Kabuki', # (斬 歌舞伎)

        # Kung Fu Chaos
        'Kung Fu Panic', # (カンフーパニック)
        ...
        'Otogi - Hyakki Toubatsu Emaki', # (Ｏ・ＴＯ・ＧＩ　～百鬼討伐絵巻～)

        # Power Drome
        'Powerdrome',

        # Prince of Persia - Warrior Within
        'Prince of Persia - Kenshi no Kokoro', # (プリンス・オブ・ペルシャ　ケンシ　ノ　ココロ)
        ...
        'Project Gotham - World Street Racer', # (プロジェクトゴッサム:ワールドストリートレーサー)

        # Puyo Pop Fever
        'Puyo Puyo Fever', # (ぷよぷよフィーバー)

        # Quantum Redshift
        'Quantum Redshift - Chou Kousoku Kuukan Battle Race', # (カンタム　レッドシフト　超高速空間バトルレース)
        ...
        # Sudeki
        'Sudeki - Sennen no Akatsuki no Monogatari', # (Sudeki　～千年の暁の物語～)

        # Tenchu - Return from Darkness
        'Tenchu 3 - Kaiki no Shou', # (天誅　参　～回帰の章～)
        ...
        # TOCA Race Driver (Europe) (Online Enabled)
        'DTM Race Driver Live',

        # TOCA Race Driver 2
        'DTM Race Driver 2 - Ultimate Racing Simulator',
        'V8 Supercars Australia - Race Driver 2',
        ...
        'UFC - Ultimate Fighting Championship 2 - Tapout', # (アルティメット　ファイティング　チャンピオンシップ　２　タップアウト)

        # Ultra Bust-A-Move
        'Ultra Puzzle Bobble', # (ウルトラパズルボブル)
        ...
        # XIII
        'XIII - Daitouryou o Koroshita Otoko', # (XIII　サーティーン　大統領を殺した男)
    ]
...
def x360_rename_list():
    return [
        ...
        'Chikyuu Boueigun 3', # (地球防衛軍4)

        # Earth Defense Force 2025
        'Chikyuu Boueigun 4', # (地球防衛軍4)
...
def pce_rename_list():
    return[
        ...
        # Cosmic Fantasy 2
        'Cosmic Fantasy 2 - Bouken Shounen Ban', # (コズミック・ファンタジー２　～冒険少年バン～)

        # Exile
        'Exile - Toki no Hasama e', # (エグザイル　～時の狭間へ～)

        # Exile - Wicked Phenomenon
        'Exile II - Janen no Jishou', # (エグザイルⅡ　～邪念の事象～)

        # Godzilla
        'Godzilla Bakutou Retsuden', # (ゴジラ爆闘烈伝)

        # J. B. Harold Murder Club
        'J. B. Harold Series 1 - Murder Club', # (Ｊ．Ｂ．ハロルド・シリーズ＃１　殺人クラブ)

        # Jack Nicklaus Turbo Golf
        'Jack Nicklaus\' World Tour Golf - 162 Holes', # (ジャック・ニクラウス・ワールド・ゴルフ・ツアー　「１６２ホール」)
        ...
        'Magical Saurus Tour', # (マジカル・サウルス・ツアー)

        # Monster Lair
        'Wonder Boy III - Monster Lair', # (ワンダー・ボーイIII　モンスター・レアー)

        # Riot Zone
        'Ookami-teki Monshou - Crest of Wolf', # (狼的紋章　クレスト・オブ・ウルフ)

        # Shadow of the Beast
        'Shadow of the Beast - Mashou no Okite', # (シャドー・オブ・ザ・ビースト　～魔性の掟～)

        # Sherlock Holmes - Consulting Detective - Volume 2
        'Sherlock Holmes - Consulting Detective Vol. II', # (シャーロック・ホームズの探偵講座II)

        # Splash Lake
        'Splash Lake - Ostrich Daibouken', # (スプラッシュ・レイク　～オストリッチ大冒険～)

        # Super Air Zonk - Rockabilly-Paradise
        'CD Denjin - Rockabilly Tengoku', # (ＣＤ電人　～ロカビリー天国～)
...
def gamecube_rename_list():
    return [
        ...
        # Amazing Island
        'Kaijuu no Shima', # (カイジュウの島 ～アメージングアイランド～)

        # Animal Crossing
        'Doubutsu no Mori +', # (どうぶつの森＋)

        # Auto Modellista
        'Auto Modellista - U.S.-tuned', # (突撃！！ ファミコンウォーズ)

        # Bad Boys - Miami Takedown
        'Bad Boys II',

        # Baten Kaitos - Eternal Wings and the Lost Ocean
        'Baten Kaitos - Owaranai Tsubasa to Ushinawareta Umi', # (バテン・カイトス 終わらない翼と失われた海)

        # Baten Kaitos Origins
        'Baten Kaitos II - Hajimari no Tsubasa to Kamigami no Shishi', # (バテン・カイトスII　始まりの翼と神々の嗣子)

        # Barbarian isn't in Redump yet
        # 'Warrior Blade - Rastan vs. Barbarian',

        # Battalion Wars
        'Totsugeki!! Famicom Wars', # (突撃！！ ファミコンウォーズ)

        # Billy Hatcher and the Giant Egg
        'Giant Egg - Billy Hatcher no Daibouken', # (ジャイアントエッグ ビリー・ハッチャーの大冒険)

        # Bloody Roar - Primal Fury
        'Bloody Roar - Extreme', # (ブラッディ ロア エクストリーム)
        ...
        # Chaos Field
        'Chaos Field Expanded', # (カオスフィールド エクスパンデッド)
        ...
        # Crash Bandicoot - The Wrath of Cortex
        'Crash Bandicoot 4 - Sakuretsu! Majin Power', # (クラッシュ・バンディクー4 さくれつ!魔神パワー)

        # Crash Nitro Kart
        'Crash Bandicoot - Bakuso! Nitro Kart', # (クラッシュ・バンディクー　爆走！ニトロカート)

        # Crash Tag Team Racing
        'Crash Bandicoot - Gatchanko World', # (クラッシュ・バンディクー がっちゃんこワールド)

        # Cubivore - Survival of the Fittest
        'Doubutsu Banchou',

        # Custom Robo
        'Custom Robo - Battle Revolution', # (カスタムロボ バトルレボリューション)
        ...
        'Disney-Pixar Mr. Incredible - Kyouteki Underminder Toujou', # (Mr. インクレディブル 強敵アンダーマイナー登場)
        ...
        'Disney\'s Mickey to Minnie Trick & Chase', # (ディズニーのミッキー＆ミニー トリック＆チェイス)

        # Disney's Magical Mirror Starring Mickey Mouse
        'Disney\'s Mickey Mouse no Fushigi na Kagami', # (ディズニーのミッキーマウスの不思議な鏡)

        # Disney's Party
        'Disney no Magical Park', # (ディズニーのマジカルパーク)
        ...
        'Disney Sports - American Football', # (ディズニー スポーツ: アメリカン フットボール)

        # Donkey Konga 2
        'Donkey Konga 2 - Hit Song Parade', # (ドンキーコンガ２　ヒットソングパレード)

        # Doshin the Giant
        'Kyojin no Doshin', # (巨人のドシン)
        ...
        'Eternal Darkness - Manekareta 13-nin', # (神機世界エヴォルシア)

        # Evolution Worlds
        'Shinki Sekai Evolutia', # (神機世界エヴォルシア)
        ...
        # FIFA Soccer 2002
        'FIFA 2002 - Road to FIFA World Cup', # (FIFA 2002: ロード トゥ FIFA ワールドカップ)
        ...
        'Godzilla - Kaijuu Dairantou', # (ゴジラ　怪獣大乱闘)

        # GoldenEye - Rogue Agent
        'GoldenEye - Agente Corrupto',
        'GoldenEye - Dark Agent', # (ゴールデンアイ ダーク・エージェント)

        # Harry Potter and the Chamber of Secrets
        'Harry Potter to Himitsu no Heiya', # (ハリー・ポッターと秘密の部屋)
        ...
        # Harvest Moon - Another Wonderful Life # (牧場物語　ワンダフルライフ)
        'Bokujou Monogatari - Wonderful Life for Girl', # (牧場物語 ワンダフルライフ for ガール)

        # Harvest Moon - Magical Melody
        'Bokujou Monogatari - Shiawase no Uta for World', # (牧場物語 しあわせの詩 for ワールド)

        # Kirby Air Ride
        'Kirby\'s Airride', # (カービィのエアライド)

        # Legend of Zelda, The - Collector's Edition
        'Zelda Collection', # (ゼルダ コレクション)

        # Legend of Zelda, The - Four Swords Adventures
        'Zelda no Densetsu - 4-tsu no Tsurugi+', # (ゼルダの伝説　４つの剣＋)

        # Legend of Zelda, The - Ocarina of Time & Master Quest
        'Zelda no Densetsu - Toki no Ocarina GC', # (ゼルダの伝説 時のオカリナGC 裏バージョン搭載)

        # Legend of Zelda, The - The Wind Waker
        'Zelda no Densetsu - Kaze no Takuto', # (ゼルダの伝説 風のタクト)

        # Legend of Zelda, The - Twilight Princess
        'Zelda no Densetsu - Twilight Princess', # (ゼルダの伝説 トワイライトプリンセス)
        ...
        # Lost Kingdoms II
        'Rune II - Koruten no Kagi no Himitsu', # (ルーンII コルテンの鍵の秘密)

        # Luigi's Mansion
        'Luigi Mansion', # (ルイージマンション)

        # Mario Golf - Toadstool Tour
        'Mario Golf - Family Tour', # (マリオゴルフ ファミリーツアー)

        # Mario Power Tennis
        'Mario Tennis GC', # (マリオテニスＧＣ)

        # Mario Superstar Baseball
        'Super Mario Stadium - Family Baseball', # (スーパーマリオスタジアム ミラクルベースボール)

        # Marvel Nemesis - Rise of the Imperfects
        'Marvel Nemesis - L\'Avenement des Imparfaits',

        # Medabots Infinity
        'Medarot Brave', # (メダロット ブレイブ)
        ...
        'Rockman EXE Transmission', # (ロックマンエグゼ　トランスミッション)

        # Mega Man X - Command Mission
        'Rockman X - Command Mission', # (ロックマンＸ コマンドミッション)

        # Metroid Prime 2 - Echos
        'Metroid Prime 2 - Dark Echoes', # (メトロイドプライム2 ダークエコーズ)

        # Minority Report - Everybody Runs
        'Minority Report - Le Futur vous Rattrape',

        # Monopoly Party
        'Monopoly - Mezase!! Daifugou Jinsei!!', # (モノポリー ～めざせっ！！大富豪人生！～)

        # Mystic Heroes
        'Battle Houshin', # (バトル封神)
        ...
        'Naruto - Gekitou Ninja Taisen! 2', # (ＮＡＲＵＴＯ－ナルト－ 激闘忍者大戦！２)
        ...
        'Pokemon XD - Yami no Kaze Dark Lugia', # (ポケモンXD 闇の旋風 ダーク・ルギア)
        ...
        # Rave Master
        'Groove Adventure Rave - Fighting Live', # (グルーヴ アドベンチャー レイヴ ファイティングライブ)
        ...
        'One Piece - Grand Battle! Rush', # (ワンピース グラバト! ラッシュ)

        # Shonen Jump's One Piece - Pirates' Carnival
        'One Piece - Pirates Carnival', # (ワンピース パイレーツカーニバル)

        # Skies of Arcadia Legends
        'Eternal Arcadia Legends', # (エターナルアルカディア レジェンド)

        # Sonic Adventure DX - Director's Cut
        'Sonic Adventure DX', # (ソニックアドベンチャー デラックス)
        ...
        # SSX On Tour
        'SSX On Tour with Mario', # (SSX オン ツアー with マリオ)
        ...
        'Dairantou Smash Brothers DX', # (大乱闘スマッシュブラザーズDX)
        ...
        'Top Gun - Ace of the Sky', # (トップガン エースオブザスカイ)
        ...
        # 'UFC - Ultimate Fighting Championship 2 - Tapout - Final Spec', # (アルティメット　ファイティング　チャンピオンシップ　２　タップアウト　ファイナルスペック)

        # Ultimate Muscle - Legends vs. New Generation
        'Kinnikuman Nisei - Shinsedai Choujin vs. Densetsu Choujin', # (キン肉マンII世 新世代超人VS伝説超人)
        ...
        # Viewtiful Joe 2
        'Viewtiful Joe 2 - Black Film no Nazo', # (ビューティフル ジョー ２ ブラックフィルムの謎)
        ...
        'Atsumare!! Made in Wario', # (あつまれ!!　メイドインワリオ)
        ...
        'Yu-Gi-Oh! Falsebound Kingdom', # (遊戯王 フォルスバウンドキングダム 虚構に閉ざされた王国)

        # Zatch Bell! Mamodo Battles
        'Konjiki no Gashbell!! Yuujou Tag Battle 2', # (金色のガッシュベル!! 友情タッグバトル2)
    ]

# Nintendo Wii
def wii_rename_list():
    return [
        # There are some localized singing games throughout Europe where I'm not
        ...
        # Aladdin Magic Racer
        'Aladin Magic Racer', # This seems like a typo on Redump's behalf
        ...
        'Wii de Yawaraka Atama Juku', # (Wiiでやわらかあたま塾)
        ...
        'Meitantei Conan - Tsuioku no Mirage', # (名探偵コナン -追憶の幻想-)
        ...
        'Narnia Koku Monogatari - Dai-2 Shou - Caspian Ouji no Tsunobue', # (ナルニア国物語/第２章:カスピアン王子の角笛)
        ...
        'Cooking Mama 2 - Taihen!! Mama wa Ooisogashi!', # (クッキングママ２たいへん!ママは おおいそがし!!)
        ...
        # Deca Sports 2
        'Sports Island 2',
        'Deca Sporta 2 - Wii de Sports 10 Shumoku!', # (デカスポルタ２)
        ...
        # DreamWorks The Croods - Prehistoric Party!, DreamWorks Rise of the Guardians
        ...
        'EA Sports Active - Personal Trainer Wii - 30-nichi Seikatsu Kaizen Program', # (パーソナルトレーナーWii30日生活改善プログラム)
        ...
        'Padrino, El - El Chantaje',
        'Padrino, Il - Blackhand Edition',
        'Parrain, Le - Pouvoir et Manipulation',

        # Gold's Gym - Cardio Workout
        'My Fitness Coach - Cardio Workout',
        'Shape Boxing - Wii de Enjoy Diet!', # (シェイプボクシング Wiiでエンジョイダイエット！)

        # Gold's Gym - Dance Workout
        'My Fitness Coach - Dance Workout',
        'Shape Boxing 2 - Wii de Enjoy Diet!', # (シェイプボクシング２ Wiiでエンジョイダイエット！)
        ...
        # Heavenly Guardian
        'Legend of Sayuki',
        'Yukinko Daisenpuu - Sayuki to Koyuki no Hie Hie Daisoudou', # (雪ん娘大旋風 〜さゆきとこゆきのひえひえ大騒動〜)
        ...
        'Pony - Mijn Paardenstal - Al Jouw Ruiterdromen Komen Uit!',
        ...
        'Era Glaciale 4, L\' - Continenti alla Deriva - Giochi Polari',
        'Ice Age 4 - Continental Drift - Arctic Games',

        # Imagine - Fashion Party
        'Imagine - Fashion Idol',
        ...
        'Ju-on - The Grudge',
        'Kyoufu Taikan - Juon', # (恐怖体感 呪怨)

        # Just Dance Kids
        'Dance Juniors',

        # Karaoke Joysound
        'Karaoke Joysound Wii', # (カラオケJOYSOUND Wii)
        ...
        # Klonoa
        'Baramui Klonoa - Door to Phantomile', # (바람의 크로노아 Door to Phantomile)
        'Kaze no Klonoa - Door to Phantomile', # (風のクロノア -door to phantomile-)

        # Kororinpa - Marble Mania
        'Kororinpa',

        # Legend of Zelda, The - Skyward Sword
        'Zelda no Densetsu - Skyward Sword', # (ゼルダの伝説 スカイウォードソード)
        ...
        'Link no Bowgun Training', # (リンクのボウガントレーニング)
        'Linkui Sagyeok Training', # (링크의　사격　트레이닝)

        # Little King's Story
        'Ousama Monogatari', # (王様物語)

        # Lost in Blue - Shipwrecked
        'Survival Kids Wii', # (サバイバルキッズWii)
        ...
        'Meja-Maji March', # (メジャマジ・マーチ)

        # Marble Saga - Kororinpa
        'Kororinpa 2 - Anthony to Kin\'iro Himawari no Tane', # (コロリンパ２ -アンソニーと黃金のひまわりのタネ-)
        'Marbles! Balance Challenge',

        # Mario Power Tennis
        'Mario Tennis GC', # (マリオテニスGC)

        # Mario & Sonic at the London 2012 Olympic Games
        'Mario & Sonic at London Olympic' , # (マリオ＆ソニック AT ロンドンオリンピック)
        'Mariowa Sonic London Olympic', # (마리오와 소닉 런던 올림픽)

        # Mario & Sonic at the Olympic Games
        'Mario & Sonic at Bejing Olympic', # (マリオ&ソニック AT 北京オリンピック)
        'Mariowa Sonic Beijing Olympic', # (마리오와 소닉 베이징 올림픽)

        # Mario & Sonic at the Olympic Winter Games
        'Mario & Sonic at Vancouver Olympic', # (マリオ＆ソニック AT バンクーバーオリンピック)
        'Mariowa Sonic Vancouver Donggye-olympic', # (마리오와 소닉 밴쿠버 동계올림픽)

        # Mario Strikers Charged
        'Mario Power Soccer', # (마리오 파워 사커)
        'Mario Strikers Charged Football',

        # Mario Super Sluggers
        'Super Mario Stadium - Family Baseball', # (スーパーマリオスタジアム ファミリーベースボール)

        # Maximum Racing - Crash Car Racer
        'Crash Car Racer',

        # Maximum Racing - Drag and Stock Racer
        'Drag & Stock Racer',
        ...
        'Metal Slug Complete', # (メタルスラッグ コンプリート)

        # Metroid Prime Trilogy
        'Metroid Prime', # (メトロイドプライム)
        'Metroid Prime 2 - Dark Echoes', # (メトロイドプライム２ ダークエコーズ)
        ...
        # MLB Power Pros
        'Jikkyou Powerful Major League 2 Wii', # (実況パワフルメジャーリーグ２)
        ...
        # Monster High - School Spirit
        'Monster High - Scuola da Paura',

        # Monster Hunter Tri
        'Monster Hunter 3 tri-', # (モンスターハンター3)
        ...
        'Naruto Shippuuden - Gekitou Ninja Taisen! EX', # (NARUTO-ナルト- 疾風伝 激闘忍者大戦!EX)

        # Naruto - Clash of Ninja Revolution III
        'Naruto Shippuden - Clash of Ninja Revolution III - European Version',
        'Naruto Shippuuden - Gekitou Ninja Taisen! EX3', # (NARUTO-ナルト- 疾風伝 激闘忍者大戦!EX3)

        # Naruto - Clash of Ninja Revolution 2
        'Naruto - Clash of Ninja Revolution 2 - European Version',
        'Naruto Shippuuden - Gekitou Ninja Taisen! EX2', # (NARUTO-ナルト- 疾風伝 激闘忍者大戦!EX2)

        # Naruto Shippuden - Dragon Blade Chronicles
        'Naruto Shippuuden - Ryuu Jin-ki', # (NARUTO -ナルト- 疾風伝 龍刃記)
        ...
        # Nickelodeon Avatar - The Last Airbender - Into the Inferno
        ...
        'Nickelodeon Bob Esponja - Botes de Choque',
        'Nickelodeon SpongeBob SquarePants - Boating Bash',

        # Nickelodeon SpongeBob SquarePants - Creature from the Krusty Krab
        'Nickelodeon SpongeBob SquarePants', # (スポンジ・ボブ)

        # Nickelodeon SpongeBob's Truth or Square
        'Nickelodeon Bob Esponja - Atrapados en el Congelador',
        'Nickelodeon SpongeBob SquarePants - SpongeBob\'s Truth or Square',

        # Nicktoons - Attack of the Toybots
        'Nickelodeon SpongeBob and Friends - Attack of the Toybots',
        'Nickelodeon SpongeBob SquarePants - SpongeBob to Nakama-tachi - Toybot no Kougeki', # (スポンジ・ボブとなかまたち トイボッツのこうげき)

        # Night at the Museum - Battle of the Smithsonian - The Video Game
        'Night at the Museum 2 - The Video Game',

        # Nights - Journey of Dreams
        'NiGHTS - Hoshi Furu Yoru no Monogatari', # (ナイツ 〜星降る夜の物語〜)

        # NPPL Championship Paintball 2009
        'Millennium European Paintball Series, The - Championship Paintball 2009',

        # Octomania
        'Modu Hamkke Takoron', # (모두 함께~☆ 타코롱)
        'Sharuui Takoron', # (しゃるうぃ〜☆たころん)
        ...
        # One Piece - Unlimited Cruise 2 - The Treasure Beneath the Waves
        'One Piece - Unlimited Cruise - Episode 1 - Nami ni Yureru Hihou', # (ワンピース アンリミテッドクルーズ エピソード1 波に揺れる秘宝)

        # One Piece - Unlimited Cruise 2 - Awakening of a Hero
        'One Piece - Unlimited Cruise - Episode 2 - Mezameru Yuusha', # (ワンピース アンリミテッドクルーズ エピソード2 目覚める勇者)

        # Onecanbara - Bikini Zombie Slayers
        'Oneechanbara Revolution', # (お姉チャンバラ Revolution)

        # Pajama Sam - Don't Fear the Dark
        'Pajama Sam - No Need to Hide When It\'s Dark Outside',

        # Pandora's Tower
        'Pandora no Tou - Kimi no Moto e Kaeru made', # (パンドラの塔 君のもとへ帰るまで)
        ...
        # PES 2009 - Pro Evolution Soccer
        'Winning Eleven Play Maker 2009', # (ウイニングイレブン プレーメーカー2009)

        # PES 2010 - Pro Evolution Soccer
        'Winning Eleven Play Maker 2010', # (ウイニングイレブン プレーメーカー2010)

        # PES 2011 - Pro Evolution Soccer
        'Winning Eleven Play Maker 2011', # (ウイニングイレブン プレーメーカー2011)

        # PES 2012 - Pro Evolution Soccer
        'Winning Eleven Play Maker 2012', # (ウイニングイレブン プレーメーカー2012)

        # PES 2013 - Pro Evolution Soccer
        'Winning Eleven Play Maker 2013', # (ウイニングイレブン プレーメーカー2013)

        # Petz - Catz 2
        'Catz',
        'Nyanko to Mahou no Boushi', # (にゃんこと魔法のぼう)
        ...
        # Petz - Dogz 2
        'Dogz',
        'Wanko to Mahou no Boushi', # (わんこと魔法のぼうし)
        ...
        'Phantom Brave Wii', # (ファントム・ブレイブWii)
        ...
        'PokePark 2 - Beyond the World', # (ポケパーク2 ビヨンド・ザ・ワールド)

        # Pokepark Wii - Pikachu's Adventure
        'PokePark Wii - Pikachu no Daibouken', # (ポケパークWii ピカチュウの大冒険)
        ...
        'Zero - Shinku no Chou', # (零～真紅の蝶～)

        # Puppy Luv - Your New Best Friend
        'Tierbabys - Mein kleiner Welpe',

        # Raving Rabbids - Travel in Time
        'Rabbids Party - Time Travel', #(ラビッツ・パーティー タイムトラベル)

        # Rayman - Raving Rabbids
        'Rabbids Party', # (ラビッツ・パーティー)

        # Rayman - Raving Rabbids - TV Party
        'Rabbids Party - TV Party', # (ラビッツ・パーティー TV Party)

        # Rayman - Raving Rabbids 2
        'Rabbids Party Returns', # (ラビッツ・パーティー リターンズ)
        ...
        'Minna no Rhythm Tengoku', # (みんなのリズム天国)
        'Rhythm Sesang Wii', # (리듬 세상 Wii)

        # Ringling Bros. and Barnum & Bailey
        'It\'s My Circus',

        # Rodea the Sky Soldier
        'Cheongongui Gisa Rodea', # (천공의　기사　로데아)

        # Rolling Stone - Drum King
        'We Rock - Drum King',

        # Rooms - The Main Building
        'Rooms - Fushigi na Ugoku Heya', # (Rooms 不思議な動く部屋)
        ...
        'Sengoku Musou - Katana', # (戦国無双 KATANA)

        # Samurai Warriors 3
        'Sengoku Musou 3', # (戦国無双3)

        # Scene It Bright Lights! Big Screen!
        'Scene It Ciak! Si Gira!',
        'Scene It Estrellas en la Pantalla Gigante',
        'Scene It Ganz grosses Kino!',
        'Scene It Lumieres! Action!',
        ...
        # Sky Crawlers, The - Innocent Aces
        'Sky Crawlers - Innocent Aces', # (スカイ・クロラ イノセン・テイセス)

        # Skylanders - Spyro's Adventure
        'Skylanders - Spyro no Daibouken', # (スカイランダーズ スパイロの大冒険)
        ...
        'Sonic to Ankoku no Kishi', # (ソニックと暗黒の騎士)

        # Sonic and the Secret Rings
        'Sonic to Himitsu no Ring', # (ソニックと秘密のリング)

        # Sonic Riders - Zero Gravity
        'Sonic Riders - Shooting Star Story', # (ソニックライダーズ シューティングスターストーリー)

        # Sonic Unleashed
        'Sonic World Adventure', # (ソニック ワールドアドベンチャー)

        # Spectrobes - Origins
        'Kaseki Monster - Spectrobes', # (化石モンスター スペクトロブス)
        ...
        # Spore Hero
        'Spore - Kimi ga Tsukuru Hero', # (スポア キミがつくるヒーロー)
        ...
        # Super Mario Galaxy
        'Super Mario Wii - Galaxy Adventure', # (슈퍼 마리오 Ｗｉｉ 갤럭시 어드벤처)

        # Super Monkey Ball - Banana Blitz
        'Super Monkey Ball - Uki Uki Party Daishuugou', # (スーパーモンキーボール ウキウキパーティー大集合)

        # Super Monkey Ball - Step & Roll
        'Super Monkey Ball Athletic', # (スーパーモンキーボール アスレチック)
        ...
        'Swing Golf Pangya', # (スイングゴルフ パンヤ)

        # Super Swing Golf Season 2
        'Swing Golf Pangya 2nd Shot!', # (スイングゴルフ パンヤ 2ndショット!)
        ...
        # Tales of Sypmhonia - Dawn of the New World
        'Tales of Symphonia - Ratatosk no Kishi', # (イルズ オブ シンフォニア ラタトスクの騎士)

        # Tamagotchi - Party On!
        'Tamagotchi no Pika Pika Daitouryou!', # (たまごっちのピカピカだいとーりょー!)
        ...
        # Think Logic Trainer
        'Entraineur Cerebral et Sportif, L\'',
        'Think - Logic Trainer',
        'Think - Logik Trainer',
        ...
        'Wario Land Shake', # (ワリオランドシェイク)
        'Wario Land Shaking', # (와리오랜드 셰이킹)

        # WarioWare - Smooth Moves
        'Chumchwora Made in Wario', # (춤춰라 메이드 인 와리오)
        'Odoru Made in Wario', # (おどるメイド イン ワリオ)
        ...
        # Wii Play
        'Cheoeum Mannaneun Wii', # (처음　만나는　Ｗｉｉ)

        # Wii Play - Motion
        'Wii Remocon Plus - Variety',
        ...
        'Zack & Wiki - Barbarosui Bomul', # (잭&위키 ~발바로스의 보물~)
    ]
...
def wii_u_rename_list():
    return [
        ...
        # Fatal Frame - Maiden of Black Water isn't in Redump yet
...
def threedo_rename_list():
    return [
        ...
        # Center Ring Boxing
        'King of Boxing, The', # (キング・オブ・ボクシング)

        # Clockwork Knight 2 - Pepperouchau's Adventure
        'Clockwork Knight - Pepperouchau no Daibouken Gekan', # (クロックワーク・ナイト　～ペパルーチョの福袋～)

        # Creature Shock - Special Edition
        'Creature Shock', # (クリーチャー・ショック)

        # Croc - Legend of the Gobbos
        'Croc! Pau-Pau Island', # (クロック！　～パウパウ・アイランド～)

        # Crypt Killer
        'Henry Explorers', # (ヘンリーエ・クスプローラーズ)

        # Cyber Speedway
        'Gran Chaser', # (グラン・チェイサー)
...
def cdi_rename_list():
    return [
        ...
        'Scotland Yard Interactive', # German title
...
def segacd_rename_list():
    return [
        ...
        # Cobra Command
        'Thunder Storm FX', # (サンダー・ストームＦＸ)

        # Dark Wizard
        'Dark Wizard - Yomigaerishi Yami no Madoushi', # (ダーク・ウィザード　～蘇りし闇の魔導士～)

        # Ecco the Dolphin
        'Ecco the Dolphin CD', # (エコー・ザ・ドルフィンＣＤ)
        ...
        'Heavenly Symphony - Formula One World Championship 1993', # (ヘブンリー・シンフォニー　～フォーミュラ・ワン・ワールド・チャンピオンシップ１９９３～)
        ...
        # Sonic CD
        'Sonic The Hedgehog CD', # (ソニック・ザ・ヘッジホッグＣＤ)
        ...
        'WWF Mania Tour - WWF - Rage in the Cage', # (ＷＷＦマニア・ツアー)
    ]
...
def dreamcast_rename_list():
    return [
        # AeroWings
        'Aero Dancing featuring Blue Impulse', # (エアロダンシング　ｆｅａｔｕｒｉｎｇ　Ｂｌｕｅ　Ｉｍｐｕｌｓｅ)

        # AeroWings 2 - Airstrike
        'Aero Dancing F', # (エアロダンシングＦ)
        ...
        # Bust-A-Move 4
        'Puzzle Bobble 4', # (パズルボブル４)

        # Cannon Spike
        'Gunspike', # (ガンスパイク)

        # Capcom vs. SNK
        'Capcom vs. SNK - Millennium Fight 2000', # (カプコンバーサスエスエヌケイ ミレニアムファイト2000)
        ...
        'Shinki Sekai Evolution 2 - Tooi Yakusoku', # (神機世界　エヴォリューション２遠い約束)

        # Expendable
        'Millennium Soldier - Expendable',

        # F355 Challenge Passione Rossa
        'F355 Challenge', # (F355チャレンジ)

        # Fatal Fury Mark of the Wolves
        'Garou - Mark of the Wolves', # (餓狼　ＭＡＲＫ　ＯＦ　ＴＨＥ　ＷＯＬＶＥＳ)
        ...
        # Iron Aces
        'Imperial no Taka - Fighter of Zero', # (インペリアルの鷹　ＦＩＧＨＴＥＲ　ＯＦ　ＺＥＲＯ)
        ...
        'King of Fighters \'99, The - Evolution', # (ザ・キング・オブ・ファイターズ’９９　ＥＶＯＬＵＴＩＯＮ)
        ...
        'Star Gladiator 2 - Nightmare of Bilstein', # (スターグラディエイター２ナイトメアオブビルシュタイン)
        ...
        # Resident Evil 2
        'Biohazard 2 - Value Plus', #(バイオハザード２)
...
def saturn_rename_list():
    return [
        # 3D Baseball
        '3D Baseball - The Majors', # (３Ｄベースボール　～ザ・メジャー～)

        # Albert Odyssey - Legend of Eldean
        'Albert Odyssey Gaiden - Legend of Eldean', # (アルバート・オデッセイ　外伝　～レジェンド・オブ・エルディーン～)
        ...
        # Astal
        'Kisuishou Densetsu Astal', # (輝水晶伝説アスタル)

        # Baku Baku Animal - World Zookeeper Contest
        'Baku Baku Animal - Sekai Shiiku Gakari Senshuken', # (ばくばくアニマル　～世界飼育係選手権～)

        # Bases Loaded '96 - Double Header
        'Moero!! Pro Yakyuu \'95 - Double Header', # (燃えろ！！　プロ野球’９５　～ダブル・ヘッダー～)

        # Battle Arena Toshinden Remix
        'Toushinden S', # (闘神伝Ｓ)

        # Battle Arena Toshinden URA - Ultimate Revenge Attack
        'Toushinden URA', # (闘神伝ＵＲＡ)
        ...
        # Galactic Attack
        'Layer Section', # (レイヤー・セクション)

        # Galaxy Fight
        'Galaxy Fight - Universal Warriors', # (ギャラクシー・ファイト　～ユニバーサル・ウォリアーズ～)
        ...
        'Gotha II - Tenkuu no Kishi', # (ゴータⅡ　～天空の騎士～)
        ...
        # In the Hunt
        'Kaitei Daisensou', # (海底大戦争)

        # Independence Day
        'Independence Day - The Game',

        # Iron Storm
        'World Advanced Daisenryaku - Koutetsu no Senpuu', # (ワールド・アドバンスド　大戦略　～鋼鉄の戦風～)

        # Jewels of the Oracle
        'Oracle no Houseki - Jewels of the Oracle',

        # Johnny Bazookatone
        'Johnny Bazooka', # (ジョニー・バズーカ)
        ...
        # Loaded
        'Blood Factory', # (ブラッド・ファクトリー)

        # Lunacy
        'Gekka Mugentan Torico', # (月花霧幻譚　ＴＯＲＩＣＯ)
        'Torico',
        ...
        # 'Shinsetsu Yumemi Yakata: Tobira no Oku ni Dareka ga...', # Not in Redump yet

        # MechWarrior 2 - 31st Century Combat - Arcade Combat Edition
        'MechWarrior 2', # (メックウォリア２)

        # Mega Man 8
        'Rockman 8 - Metal Heroes', # (ロックマン８　～メタル・ヒーローズ～)
        ...
        'Side Pocket 2 - Densetsu no Hustler', # (サイド・ポケット２　～伝説のハスラー～)

        # Mystaria - The Realms of Lore
        'Blazing Heroes',
        'Riglordsaga', # (リグロード・サーガ)
        ...
        'Teitoku no Ketsudan II', # (提督の決断Ⅱ)

        # Pandemonium!
        'Magical Hoppers', # (マジカル・ホッパーズ)

        # Panzer Dragoon Saga
        'Azel - Panzer Dragoon RPG', # (アゼル　～パンツァー・ドラグーンＲＰＧ～　【体験版】)
        ...
        # Road & Track Presents - The Need for Speed
        'Nissan Presents - Over Drivin\' GT-R', # (オーバードライビング　ＧＴ－Ｒ)
        ...
        'Street Fighter Zero', # (ストリート・ファイターＺＥＲＯ)

        # Street Fighter Alpha 2
        'Street Fighter Zero 2', # (ストリート・ファイターＺＥＲＯ２)

        # Street Racer
        'Street Racer Extra', # (ストリート・レーサー・エクストラ)

        # Super Puzzle Fighter II Turbo
        'Super Puzzle Fighter II X', # (スーパー・パズル・ファイターⅡX)
        ...
        # Tunnel B1
        '3D Mission Shooting - Finalist', # (３Ｄミッション・シューティング　～ファイナリスト～)
        ...
        'Virtua Fighter CG Portrait Series Vol. 1 - Sarah Bryant',  # (バーチャ・ファイター　ＣＧポートレート・シリーズ　Ｖｏｌ．１　「サラ・ブライアント」)
        'Virtua Fighter CG Portrait Series Vol. 10 - Jeffry McWild',  # (バーチャ・ファイター　ＣＧポートレート・シリーズ　Ｖｏｌ．１０　「ジェフリー・マクワイルト」)
        'Virtua Fighter CG Portrait Series Vol. 2 - Jacky Bryant',  # (バーチャ・ファイター　ＣＧポートレート・シリーズ　Ｖｏｌ．２　「ジャッキー・ブライアント」)
        'Virtua Fighter CG Portrait Series Vol. 3 - Akira Yuki', # (バーチャ・ファイター　ＣＧポートレート・シリーズ　Ｖｏｌ．３　「結城　晶」)
        'Virtua Fighter CG Portrait Series Vol. 4 - Pai Chan', # (バーチャ・ファイター　ＣＧポートレート・シリーズ　Ｖｏｌ．４　「パイ・チェン」)
        'Virtua Fighter CG Portrait Series Vol. 5 - Wolf Hawkfield', # (バーチャ・ファイター　ＣＧポートレート・シリーズ　Ｖｏｌ．５　「ウルフ・ホークフィールド」)
        'Virtua Fighter CG Portrait Series Vol. 6 - Lau Chan', # (バーチャ・ファイター　ＣＧポートレート・シリーズ　Ｖｏｌ．６　「ラウ・チェン」)
        'Virtua Fighter CG Portrait Series Vol. 7 - Shun Di', # (バーチャ・ファイター　ＣＧポートレート・シリーズ　Ｖｏｌ．７　「舜帝」)
        'Virtua Fighter CG Portrait Series Vol. 8 - Lion Rafale', # (バーチャ・ファイター　ＣＧポートレート・シリーズ　Ｖｏｌ．８　「リオン・ラファール」)
        'Virtua Fighter CG Portrait Series Vol. 9 - Kage Maru', # (バーチャ・ファイター　ＣＧポートレート・シリーズ　Ｖｏｌ．９　「影丸」)
...
def psx_rename_list():
    return [
        ...
        # Breakout
        'Breakout - A Story of Bat Meets Ball...!',
        ...
        # NBA Shootout isn't in Redump yet
        # 'Total NBA \'96',

        # NBA Shootout 97 isn't in Redump yet
        # 'Total NBA \'97',
        ...
        # Pro-Pinball isn't in Redump yet
        # 'Pro Pinball - The Web',
        ...
        'Tiger Woods 99 USA Tour Golf',

        # Tiger Woods PGA Tour 2000
        'Tiger Woods USA Tour 2000',
        ...
        # Winning Eleven 6 isn't in Redump yet
...
def ps2_rename_list():
    return [
        ...
        # Buzz! Junior - RoboJam, and Buzz! Junior - Jungle Party
        'Buzz! Junior - RoboJam + Buzz! Junior - Jungle Party',
        ...
        # Devil May Cry 3 - Dante's Awakening, and Devil May Cry 3 - Dante's Awakening (Special Edition)
        'Devil May Cry 3',
        ...
        # Jak X - Combat Racing, and Ratchet - Deadlocked
        ...
        # King of Fighters 2000, The, and King of Fighters 2001, The
        'King of Fighters 2000-2001, The',
        ...
        'Nickelodeon SpongeBob and Friends - Battle for Volcano Island',
        ...
        # Primal, and The Mark of Kri, and War of the Monsters
        ...
        # Ratchet & Clank - Up Your Arsenal, and Sly 2 - Band of Thieves
        ...
        'Silent Hill 2 - Saigo no Uta', # (サイレント・ヒル2 ～最期の詩～)
...
def ps3_rename_list():
    return [
        ...
        # Assassin's Creed, Assassin's Creed II, Assassin's Creed - Brotherhood, Assassin's Creed - Revelations, Assassin's Creed III
        ...
        # Darksiders
        'Darksiders - Shinpan no Toki', # (ダークサイダーズ ~審判の時~)

        # Dead Island, Dead Island - Riptide
        'Dead Island - Double Pack',
        ...
        # Ico & Shadow of the Colossus Collection, The
        ...
        # Naruto - Ultimate Ninja Storm, Naruto - Ultimate Ninja Storm 2, Naruto Shippuden - Ultimate Ninja Storm 3 Full Burst
        ...
        # Prince of Persia - The Forgotten Sands
        'Prince of Persia - Boukyaku no Suna', # ((プリンス・オブ・ペルシャ 忘却の砂)

        # R.U.S.E. - The Art of Deception
        'R.U.S.E.',

        # Ratchet & Clank Collection
        'Ratchet & Clank Trilogy, The',
        ...
        'Resistance - Jinrui Botsuraku no Hi', # (人類没落の日)
        ...
        'Tom Clancy\'s Ghost Recon Double Pack',

        # Uncharted - Drake's Fortune
        'Uncharted - El Dorado no Hihou', # (アンチャーテッド エル・ドラドの秘宝)

        # Uncharted 2 - Among Thieves
        'Uncharted - Ougontou to Kieta Sendan', # (アンチャーテッド 黄金刀と消えた船団)

        # Uncharted 3 - Drake's Deception
        'Uncharted - Sabaku ni Nemuru Atlantis', # (アンチャーテッド 砂漠に眠るアトランティス)
...
def ps4_rename_list():
    return [
        ...
        'Uncharted - Kaizoku-ou to Saigo no Hihou', # (アンチャーテッド 海賊王と最後の秘宝)
...
def psp_rename_list():
    return [
        ...
        'God of War - Koutan no Kokuin', # (ゴッド・オブ・ウォー 降誕の刻印)

        # Godfather, The - Mob Wars
        'Godfather, The',
        ...
        # PES 2008 - Pro Evolution Soccer
        'World Soccer Winning Eleven - Ubiquitous Evolution 2008',
        ...
        'PixelJunk Monsters UMD Limited Edition',
