...
def cd32_superset_list():
    return {

    }

# Commodore Amiga CDTV
def cdtv_superset_list():
    return {
...
def ibm_superset_list():
    return {
        ...
        'Fable - The Lost Chapters (Disc 1)': ['Fable'],
        'Fallout - New Vegas (Ultimate Edition)': ['Fallout - New Vegas'],
        'Fallout 3 (Disc 1) (Game of the Year Edition)': [
            'Fallout 3',
        ...
        'Fallout Trilogy': [
            ...
            'Fallout (9A6EFB7C)',
            'Fallout 2',
            'Fallout Tactics - Brotherhood of Steel (Bonus Disc)',
            'Fallout Tactics - Brotherhood of Steel (Disc 1)',
            'Fallout Tactics - Brotherhood of Steel (Disc 2)',
            'Fallout Tactics - Brotherhood of Steel (Disc 3)',
        ],
        'Fighter Duel - Special Edition': ['Fighter Duel'],
        'Fleet Defender Gold': ['Fleet Defender'],
        'Fly! (Disc 1) (Install Disc)': ['Fly! 2K (Disc 1)'],
...
# Panasonic 3DO
def threedo_superset_list():
    return {

    }

# Philips - CD-i
def cdi_superset_list():
    return {
