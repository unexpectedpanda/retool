...
def main() -> None:
    ...
    golden_comparison_folder = 'features/machine-tags'
    test_name = 'Machine tags'
    arguments_list = [
        '--test --config tests/configs/user-config-regions-1.yaml --machine',
    ]
