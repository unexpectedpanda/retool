...
"""Prefer titles with RetroAchievements integration test."""
...
def main() -> None:
    ...
    golden_comparison_folder = 'features/prefer-retroachievements'
    test_name = 'Prefer RetroAchievements'
    arguments_list = [
        '--test --config tests/configs/user-config-regions-1.yaml -c',
    ]
